...
internal/
  ...
  gitdiff/            git working-tree + single-commit diff computation (git shell-out, file-level diff parsing) plus batch gitignore checks (`CheckIgnore`) reused by the fs browse API — no plugin/session dependency
